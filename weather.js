...
const getData = async () => {
    ...
    let feels_like = json_res.weather[0].description;
    let feel = `<p> ${feels_like}</p>`;
    
    document.getElementById('feel').innerHTML = feel;
    
    // async function fetchData() {
    //   try {
    //      const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=44.34&lon=10.99&appid=4b566653c56018c8cf1d63241c14865b`);
